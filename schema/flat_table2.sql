...
CREATE TABLE `flat_table2` (
  ...
  `side_effects_dizziness` varchar(45) DEFAULT NULL,
  ...
  `prescribe_ipt_yes` varchar(255) DEFAULT NULL,
  `prescribe_ipt_no` varchar(255) DEFAULT NULL,
  ...
  `guardian_present_unknown` varchar(255) DEFAULT NULL,
  `patient_present_yes` varchar(255) DEFAULT NULL,
  `patient_present_no` varchar(255) DEFAULT NULL,
  `patient_present_unknown` varchar(255) DEFAULT NULL,
  ...
  `breastfeeding_unknown_enc_id` varchar(255) DEFAULT NULL,
  ...
  `symptom_present_nightmares_enc_id` int(11) DEFAULT NULL,
  ...
  `side_effects_dizziness_enc_id` int(11) DEFAULT NULL,
  ...
  `prescribe_ipt_yes_enc_id` int(11) DEFAULT NULL,
  `prescribe_ipt_no_enc_id` int(11) DEFAULT NULL,
  ...
  `guardian_present_unknown_enc_id` int(11) DEFAULT NULL,
  `patient_present_yes_enc_id` int(11) DEFAULT NULL,
  `patient_present_no_enc_id` int(11) DEFAULT NULL,
  `patient_present_unknown_enc_id` int(11) DEFAULT NULL,
