...
CREATE TABLE `flat_table2` (
  ...
  `condoms_given` int(11) DEFAULT NULL,
  ...
  `amount_of_drug1_brought_to_clinic` varchar(45) DEFAULT NULL,
  `amount_of_drug1_remaining_at_home` varchar(45) DEFAULT NULL,
  `what_was_the_patient_adherence_for_this_drug1` varchar(45) DEFAULT NULL,
  `missed_hiv_drug_construct1` varchar(255) DEFAULT NULL,
  `amount_of_remaining_drug1_order_id` int(11) DEFAULT NULL,
  `amount_of_drug2_brought_to_clinic` varchar(45) DEFAULT NULL,
  `amount_of_drug2_remaining_at_home` varchar(45) DEFAULT NULL,
  `what_was_the_patient_adherence_for_this_drug2` varchar(45) DEFAULT NULL,
  `missed_hiv_drug_construct2` varchar(255) DEFAULT NULL,
  `amount_of_remaining_drug2_order_id` int(11) DEFAULT NULL,
  `amount_of_drug3_brought_to_clinic` varchar(45) DEFAULT NULL,
  `amount_of_drug3_remaining_at_home` varchar(45) DEFAULT NULL,
  `what_was_the_patient_adherence_for_this_drug3` varchar(45) DEFAULT NULL,
  `missed_hiv_drug_construct3` varchar(255) DEFAULT NULL,
  `amount_of_remaining_drug3_order_id` int(11) DEFAULT NULL,
  `amount_of_drug4_brought_to_clinic` varchar(45) DEFAULT NULL,
  `amount_of_drug4_remaining_at_home` varchar(45) DEFAULT NULL,
  `what_was_the_patient_adherence_for_this_drug4` varchar(45) DEFAULT NULL,
  `missed_hiv_drug_construct4` varchar(255) DEFAULT NULL,
  `amount_of_remaining_drug4_order_id` int(11) DEFAULT NULL,
  `amount_of_drug5_brought_to_clinic` varchar(45) DEFAULT NULL,
  `amount_of_drug5_remaining_at_home` varchar(45) DEFAULT NULL,
  ...
  `family_planning_method_enc_id`  int(11) DEFAULT NULL,
  ...
  `side_effects_present_enc_id` int(11) DEFAULT NULL,
  ...
  `tb_status_enc_id` int(11) DEFAULT NULL,
  ...
  `amount_of_remaining_drug1_order_id_enc_id` int(11) DEFAULT NULL,
  ...
  `amount_of_remaining_drug2_order_id_enc_id` int(11) DEFAULT NULL,
  ...
  `amount_of_remaining_drug3_order_id_enc_id` int(11) DEFAULT NULL,
  ...
  `amount_of_remaining_drug4_order_id_enc_id` int(11) DEFAULT NULL,
  ...
  `amount_of_remaining_drug5_order_id_enc_id` int(11) DEFAULT NULL,
  ...
  `date_exiting_from_care_enc_id` int(11) DEFAULT NULL,
