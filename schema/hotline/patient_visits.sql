...
CREATE TABLE `patient_visits` (
  ...
  `severity_of_cough` varchar(10) DEFAULT NULL,
  `severity_of_diarrhea` varchar(10) DEFAULT NULL,
  `severity_of_fever` varchar(10) DEFAULT NULL,
  `severity_of_red_eye` varchar(10) DEFAULT NULL,
  `red_eye` varchar(10) DEFAULT NULL,
  `flaky_skin` varchar(10) DEFAULT NULL,
  `breakfast` VARCHAR(50) DEFAULT NULL,
  `lunch` VARCHAR(50) DEFAULT NULL,
  `supper` VARCHAR(50) DEFAULT NULL,
  `snack` VARCHAR(50) DEFAULT NULL,
  `staples`  VARCHAR(50) DEFAULT NULL,
  `legumes_and_nuts`  VARCHAR(50) DEFAULT NULL,
  `animal_food`  VARCHAR(50) DEFAULT NULL,
  `fruits`  VARCHAR(50) DEFAULT NULL,
  `vegetables`  VARCHAR(50) DEFAULT NULL,
  `fats`  VARCHAR(50) DEFAULT NULL,
  `breastmilk` VARCHAR(50) DEFAULT NULL,
  `foods` VARCHAR(50) DEFAULT NULL,
  `other_liquids` VARCHAR(50) DEFAULT NULL,
  `consumption_method` VARCHAR(50) DEFAULT NULL,
  `breastmilk_enc_id` INT(11) DEFAULT NULL,
  `foods_enc_id` INT(11) DEFAULT NULL,
  `other_liquids_enc_id` INT(11) DEFAULT NULL,
  `consumption_method_enc_id` INT(11) DEFAULT NULL,
  `staples_enc_id` INT(11) DEFAULT NULL,
  `legumes_and_nuts_enc_id` INT(11) DEFAULT NULL,
  `animal_food_enc_id` INT(11) DEFAULT NULL,
  `fruits_enc_id` INT(11) DEFAULT NULL,
  `vegetables_enc_id` INT(11) DEFAULT NULL,
  `fats_enc_id` INT(11) DEFAULT NULL,
  `breakfast_enc_id` INT(11) DEFAULT NULL,
  `lunch_enc_id` INT(11) DEFAULT NULL,
  `supper_enc_id` INT(11) DEFAULT NULL,
  `snack_enc_id` INT(11) DEFAULT NULL,
  `clinic_enc_id` INT(11) DEFAULT NULL,
  `nearest_health_facility_enc_id` INT(11) DEFAULT NULL,
  `fever_of_7_days_or_more_enc_id` INT(11) DEFAULT NULL,
  `diarrhea_for_14_days_or_more_enc_id` INT(11) DEFAULT NULL,
  `blood_in_stool_enc_id` INT(11) DEFAULT NULL,
  `cough_for_21_days_or_more_enc_id` INT(11) DEFAULT NULL,
  `not_eating_or_drinking_anything_enc_id` INT(11) DEFAULT NULL,
  `red_eye_for_4_days_or_more_with_visual_problems_enc_id` INT(11) DEFAULT NULL,
  `very_sleepy_or_unconscious_enc_id` INT(11) DEFAULT NULL,
  `convulsions_sign_enc_id` INT(11) DEFAULT NULL,
  `vomiting_everything_enc_id` INT(11) DEFAULT NULL,
  `visual_problems_enc_id` INT(11) DEFAULT NULL,
  `cough_enc_id` INT(11) DEFAULT NULL,
  `not_eating_enc_id` INT(11) DEFAULT NULL,
  `unconscious_enc_id` INT(11) DEFAULT NULL,
  `gained_or_lost_weight_enc_id` INT(11) DEFAULT NULL,
  `severity_of_cough_enc_id` INT(11) DEFAULT NULL,
  `severity_of_diarrhea_enc_id` INT(11) DEFAULT NULL,
  `severity_of_fever_enc_id` INT(11) DEFAULT NULL,
  `severity_of_red_eye_enc_id` INT(11) DEFAULT NULL,
  `red_eye_enc_id` INT(11) DEFAULT NULL,
  `flaky_skin_enc_id` INT(11) DEFAULT NULL,
  ...
  `cervical_cancer_enc_id` INT(11) DEFAULT NULL,
