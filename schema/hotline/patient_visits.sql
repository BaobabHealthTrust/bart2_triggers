...
CREATE TABLE `patient_visits` (
  ...
  `danger_signs` varchar(255) DEFAULT NULL,
  `health_symptoms` varchar(255) DEFAULT NULL,
  `health_information` varchar(255) DEFAULT NULL,
  ...
  `danger_signs_enc_id` int(11) DEFAULT NULL,
  `health_symptoms_enc_id` int(11) DEFAULT NULL,
  `health_information_enc_id` int(11) DEFAULT NULL,
