...
CREATE TABLE `patient_demographics` (
  ...
  `IVR_access_code` varchar(255) DEFAULT NULL,
  `anc_connect_id` varchar(255) DEFAULT NULL,
  `cellphone_number` varchar(255) DEFAULT NULL,
  `nearest_health_facility` varchar(255) DEFAULT NULL,
  `current_residence` varchar(255) DEFAULT NULL,
  `current_ta` varchar(255) DEFAULT NULL,
  `home_village` varchar(255) DEFAULT NULL,
  `group_village_head` varchar(255) DEFAULT NULL,
