...
CREATE TABLE `flat_cohort_table`(
  ...
  `side_effects_cough` varchar(255) DEFAULT NULL,
  `side_effects_diarrhea` varchar(255) DEFAULT NULL,
  `side_effects_diziness` varchar(255) DEFAULT NULL,
  `side_effects_fever` varchar(255) DEFAULT NULL,
  `side_effects_hepatitis` varchar(255) DEFAULT NULL,
  `side_effects_jaundice` varchar(255) DEFAULT NULL,
  `side_effects_kidney_failure` varchar(255) DEFAULT NULL,
  `side_effects_lactic_acidosis` varchar(255) DEFAULT NULL,
  `side_effects_leg_pain_numbness` varchar(255) DEFAULT NULL,
  ...
  `side_effects_vomiting` varchar(255) DEFAULT NULL,
  ...
  `tb_status_v_date` DATE DEFAULT NULL,
