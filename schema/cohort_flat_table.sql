...
CREATE TABLE `flat_cohort_table`(
  ...
  `side_effects_abdominal_pain` int(11) DEFAULT NULL,
  `side_effects_anemia` int(11) DEFAULT NULL,
  `side_effects_anorexia` int(11) DEFAULT NULL,
  `side_effects_blurry_vision` int(11) DEFAULT NULL,
  `side_effects_cough` int(11) DEFAULT NULL,
  `side_effects_diarrhea` int(11) DEFAULT NULL,
  `side_effects_diziness` int(11) DEFAULT NULL,
  `side_effects_fever` int(11) DEFAULT NULL,
  `side_effects_hepatitis` int(11) DEFAULT NULL,
  `side_effects_jaundice` int(11) DEFAULT NULL,
  `side_effects_kidney_failure` int(11) DEFAULT NULL,
  `side_effects_lactic_acidosis` int(11) DEFAULT NULL,
  `side_effects_leg_pain_numbness` int(11) DEFAULT NULL,
  `side_effects_lipodystrophy` int(11) DEFAULT NULL,
  `side_effects_no` int(11) DEFAULT NULL,
  `side_effects_other` int(11) DEFAULT NULL,
  `side_effects_peripheral_neuropathy` int(11) DEFAULT NULL,
  `side_effects_psychosis` int(11) DEFAULT NULL,
  `side_effects_renal_failure` int(11) DEFAULT NULL,
  `side_effects_skin_rash` int(11) DEFAULT NULL,
  `side_effects_vomiting` int(11) DEFAULT NULL,
  `side_effects_gynaecomastia` int(11) DEFAULT NULL,
  `side_effects_nightmares` int(11) DEFAULT NULL,
