        ...
        WHEN @drug_set1 = "" THEN
            ...
            IF @visit = 0 THEN
                ...
                VALUES (@patient_id, in_visit_date, new.order_id, new.encounter_id, 
                    new.start_date, new.auto_expire_date);
        ...
        WHEN @drug_set2 = "" THEN        
            ...
            IF @visit = 0 THEN
                ...
                INSERT INTO flat_table2 (patient_id, visit_date, drug_order_id2, 
                    drug_encounter_id2, drug_start_date2, drug_auto_expire_date2) 
                VALUES (@patient_id, in_visit_date, new.order_id, new.encounter_id, 
                    new.start_date, new.auto_expire_date);
        ...
        WHEN @drug_set3 = "" THEN
            ...
            IF @visit = 0 THEN
                ...
                INSERT INTO flat_table2 (patient_id, visit_date, drug_order_id3, 
                    drug_encounter_id3, drug_start_date3, drug_auto_expire_date3) 
                VALUES (@patient_id, in_visit_date, new.order_id, new.encounter_id, 
                    new.start_date, new.auto_expire_date);
        ...
        WHEN @drug_set4 = "" THEN
            ...
            IF @visit = 0 THEN
                ...
                INSERT INTO flat_table2 (patient_id, visit_date, drug_order_id4, 
                    drug_encounter_id4, drug_start_date4, drug_auto_expire_date4) 
                VALUES (@patient_id, in_visit_date, new.order_id, new.encounter_id, 
                    new.start_date, new.auto_expire_date);
        ...
        WHEN @drug_set5 = "" THEN
            ...
            IF @visit = 0 THEN
                ...
                INSERT INTO flat_table2 (patient_id, visit_date, drug_order_id5, 
                    drug_encounter_id5, drug_start_date5, drug_auto_expire_date5) 
                VALUES (@patient_id, in_visit_date, new.order_id, new.encounter_id, 
                    new.start_date, new.auto_expire_date);
