...
BEGIN
    ...
    END IF;
      ...
      SET @date_enrolled = (SELECT date_enrolled from earliest_start_date where patient_id = @patient_id);

			IF @start_date IS NULL THEN

				UPDATE flat_table1 SET earliest_start_date = new.start_date, date_enrolled = @date_enrolled, age_at_initiation = @age_at_initiation, age_in_days = @age_in_days WHERE patient_id = @patient_id;
