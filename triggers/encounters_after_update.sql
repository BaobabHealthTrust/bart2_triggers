        ...
        read_loop: LOOP
            ...
            # Not done, process the parameters
              ...
              IF new.voided = 1 THEN
                  ...
                  SET @malawi_ART_side_effects = (SELECT concept_name.concept_id FROM concept_name
                                      LEFT OUTER JOIN concept ON concept.concept_id = concept_name.concept_id
                                      WHERE name = "Malawi ART side effects" AND voided = 0 AND retired = 0 LIMIT 1);
                  ...
                  ELSE
                    ...
                    CALL proc_update_other_field(var_person_id, var_concept_id, var_value_coded, OLD.encounter_id, new.voided);
                  END CASE;
