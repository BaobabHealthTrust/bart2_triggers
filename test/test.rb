  ...
  def test
    begin
      ...
      fields_set1 = [
        ...
        # ["patient_present", "No", "Text", "Patient present", "No", "No"],
        ...
        ["routine_tb_screening_weight_loss_failure_to_thrive_malnutrition", "NO", "Text", "Routine TB Screening", "Weight loss / Failure to thrive / malnutrition", "Weight loss / Failure to thrive / malnutrition"],
