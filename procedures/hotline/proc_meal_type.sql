  ...
  CASE in_field_text
    WHEN 'Breakfast' THEN
      ...
      ELSE
        IF in_visit_id = 0 THEN
          UPDATE patient_visits
          SET visit_date = in_visit_date,  breakfast = 'Yes', breakfast_enc_id = encounter_id
    ...
    WHEN 'Lunch' THEN
      ...
      ELSE
        IF in_visit_id = 0 THEN
          UPDATE patient_visits
          SET visit_date = in_visit_date,  lunch = 'Yes', lunch_enc_id = encounter_id
          WHERE patient_id = in_patient_id;
        ELSE
          IF in_field_voided = 0 THEN
            UPDATE patient_visits
    ...
    WHEN 'Supper' THEN
      ...
      ELSE
        IF in_visit_id = 0 THEN
          UPDATE patient_visits
          SET visit_date = in_visit_date,  supper = 'Yes', supper_enc_id = encounter_id
          WHERE patient_id = in_patient_id;
        ELSE
          IF in_field_voided = 0 THEN
            UPDATE patient_visits
    ...
    WHEN 'Snack' THEN
      ...
      ELSE
        IF in_visit_id = 0 THEN
          UPDATE patient_visits
          SET visit_date = in_visit_date,  snack = 'Yes', snack_enc_id = encounter_id
          WHERE patient_id = in_patient_id;
        ELSE
          IF in_field_voided = 0 THEN
            UPDATE patient_visits
