    ...
    CASE in_field_value_coded
        ...
        WHEN @yes THEN
            ...
            IF in_field_voided = 0 THEN    
              ...
              END IF;
            ELSE
              UPDATE flat_table2 SET breastfeeding_yes = NULL, breastfeeding_no = NULL, breastfeeding_yes_enc_id = NULL, breastfeeding_no_enc_id = NULL WHERE flat_table2.id = in_visit_id;
            END IF;
        WHEN @no THEN
            ...
            IF in_field_voided = 0 THEN
              ...
              END IF;                   
            ELSE
              UPDATE flat_table2 SET breastfeeding_no = NULL, breastfeeding_yes = NULL, breastfeeding_no_enc_id = NULL, breastfeeding_yes_enc_id = NULL WHERE flat_table2.id = in_visit_id;            
            END IF;    
        ELSE
