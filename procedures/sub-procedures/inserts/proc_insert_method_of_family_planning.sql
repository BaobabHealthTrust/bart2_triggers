    ...
    CASE in_field_value_coded
        ...
        WHEN @family_planning_method__rythm_method THEN
            ...
            IF in_field_voided = 0 THEN
              ...
              END IF;
            ELSE
              UPDATE flat_table2 SET family_planning_method__rythm_method = NULL, family_planning_method__rythm_method_enc_id = NULL WHERE flat_table2.id = in_visit_id;
            END IF;
        ...
        WHEN @family_planning_method_emergency__contraception THEN
            ...
            IF in_field_voided = 0 THEN
              ...
              END IF;
           ELSE
             UPDATE flat_table2 SET family_planning_method_emergency__contraception = NULL, family_planning_method_emergency__contraception_enc_id = NULL WHERE flat_table2.id = in_visit_id;
           END IF;
